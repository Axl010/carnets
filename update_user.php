            ...
            <div class="row justify-content-center">
                <div class="col-lg-9 col-md-12 col-sm-12 my-3">
                    <div class="d-flex align-items-center"> 
                        ...
                        <h2 class="h4 ms-1">Editar Usuario</h2>
                    </div>
                </div>
                    ...
                    <div class="card"> 
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="nombre" id="nombre" value="<?= $usuario_data['nombre'] ?>" tabindex="1" required/>
                            </div>
                        </div><!--/.card body -->
                    </div>    
                    <div class="card mt-3"> 
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    ...
                    <div class="d-flex flex-row-reverse mt-4">
                        <input type="submit" class="btn btn-primary btn-sm btn-submit" name="update_user" value="Guardar" tabindex="5">
